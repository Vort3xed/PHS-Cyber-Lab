  ...
  <div className="container mb-5">
    ...
    <div className="row">
      <div className="col-sm-12 col-md-7 col-lg-7">
        ...
        <div className="d-flex justify-content-start mb-2"> 
          <a href={translation.label["instagram-link"]} target="_blank" rel="noopener noreferrer">
        ...
        <div className="d-flex justify-content-start mb-2">
          ...
          <a href={translation.label["github-link"]} target="_blank" rel="noopener noreferrer">
        ...
        <a href={translation.label["discord-link"]} target="_blank" rel="noopener noreferrer">
          <span className="social-discord-link">{translation.label["discord-link"]}</span>
        </a>
        </div>
        ...
        <a href="mailto:contact@phscyberlab.org" target="_blank" rel="noopener noreferrer">
          <span className="social-email-link">{translation.label["email-address"]}</span>
        </a>
        </div>
      </div>
